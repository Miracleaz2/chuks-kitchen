# Truemind Intern – Chuks Kitchen Frontend

A responsive frontend prototype for **Chuks Kitchen**, built with HTML and CSS (with a small amount of JavaScript for form interactions).

## Project Structure

- Frontend/welcome_page.html – landing/welcome page
...
- This is currently a frontend-only project (no backend/API integration yet).
- Some links and interactions are set for testing flow.
